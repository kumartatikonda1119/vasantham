...
import poemsData from '../data/kavithalu.json';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="font-sans text-base text-[#5C4328] font-medium">
            పదాలతో పూచిన భావాల పువ్వులు, హృదయానికి హత్తుకునే కవితలు.
          </p>
        ...
        <div className="grid grid-cols-1 gap-8">
          {poemsData.map((poem, index) => (
            ...
            >
              <div>
                ...
                <div className="font-sans text-base text-[#5C4328] leading-relaxed my-4 italic space-y-2 text-center">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-6 pt-4 border-t border-[#E6D7BD] gap-4 sm:gap-0">
                <span className="font-serif text-xs text-[#A08530] font-bold">
                  – {poem.author || 'Geeta Vasanta Laxmi (వసంతం)'}
                </span>

                <div className="flex items-center gap-2 self-end sm:self-auto">
                  <button
                    onClick={() => setShareItem({ ...poem, content: poem.content.join('\n'), action: 'download' })}
          ...
          {poemsData.length === 0 && (
            <div className="text-center py-16 bg-[#F8F1E4] rounded-3xl border border-[#E6D7BD] text-[#6C5338]">
              ప్రస్తుతం ఏ కవితలు అందుబాటులో లేవు.
            </div>
          )}
        </div>
